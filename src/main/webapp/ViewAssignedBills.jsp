...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/ViewAssignedBills.css" />
...
<body>
    ...
    <%
    	...
    	if(user == null){
    		...
    		String mySessionDealerID = (String) request.getParameter("mySessionDealerID");
    		User dealer = (User) session.getAttribute(mySessionDealerID);
    		String mySessionDealerIDBillList = (String) request.getParameter("mySessionDealerIDBillList");
    		List<Bill> dealerBillList = (List<Bill>) session.getAttribute(mySessionDealerIDBillList);
    %>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  ...
	  <div class="firmHeadingContainer">
	  	<h3>Bills assigned to <%= dealer.getFirmName() %></h3>
	  </div>
      <div class="fContainer">
            <div class="optionsContainer">
            	<form id="billStatusForm" method="post" action="DealerBillsAccordingToStatusServlet">
                <div class="option">
                ...
                <form id="billSortingForm" method="post" action="DealerBillsAccordingToSortingServlet">
                <div class="option">
            ...
            <div class="amountContainer">
            	<h4>Total Amount to be received : 
            	<%  
            		double totalAmount = 0;
            		for(Bill bill : dealerBillList){
            			if(bill.getBillStatus().equalsIgnoreCase("unpaid"))
            			{
            				totalAmount += bill.getBillAmount();
            			}
            		}
            		out.println(totalAmount + " Rs.");
            	%>
            	</h4>
            </div>
                ...
                <table class="table table-striped table-fixed">
                    ...
                    %>
                      <tr>
                        ...
                        <td><i class="fa-solid fa-pen" style="color: #565e6c;"></i></i></td>
                        <td><i class="fa-solid fa-trash" style="color: #d52410;"></i></td>
                        <%} %>
                      </tr>
                      <%
                    	}
