...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/AssignNewBill.css"/>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  ...
	  <%
	  	 ...
	  	 if(message != null && message.equals("Bill already exists")){
	  		 %>
	  		 <script>
	  			...
	  			Toast.fire({
  		  		icon: 'error',
	  		  	title: 'Bill No. already exists'
	  			})
	  		</script>
	  		 <% 
	  	 }else if(message != null && message.equals("Bill successfully inserted") ){
	  		 %>
	  		 	<script>
	  			const Toast = Swal.mixin({
	  		  	toast: true,
	  			...
	  			Toast.fire({
  		  		icon: 'success',
	  		  	title: 'Bill successfully inserted into <%= dealer.getFirmName() %>'
	  			})
	  			</script>
	  		 <%
	  ...
	  %>
      <div class="fHeading">
        <h1>Add Bill details for <%= dealer.getFirmName() %></h1>
      </div>
      
      <form method="post" action="AssignNewBillServlet" enctype="multipart/form-data">
      <div class="fContainer">
        <div class="billContainer">
            <div class="container1">
 				<input type="hidden" name="mySessionDealerID" value="<%= mySessionDealerID%>">           
                <div class="field1">
                    <p>Bill Date</p>
                ...
                <div class="field1">
                    <p>Bill Amount</p>
                    <input type="number" name="billAmount" required>
                </div>
                <div class="field1">
                    <p>Due Days</p>
                    <input type="number" name="dueDays" required>
                </div>
            ...
            <div class="container2">
                ...
                <div class="field1">
                    <p>Bill PDF</p>
                    <input type="file" name="billPDF" required>
                </div>
                <div class="field2">
                    <p>Bill Status</p>
                    <span>Paid</span><input type="radio" name="billStatus" value="paid" required>
                    <span>Unpaid</span><input type="radio" name="billStatus" value="unpaid" required>
                </div>
                <div class="field1">
